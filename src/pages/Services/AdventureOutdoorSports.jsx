    ...
    <div className="font-sans bg-gray-50 text-gray-800">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto mb-10">
          Develop courage, stamina, and unstoppable confidence with adventure
          sports training.
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-white rounded-xl p-8 shadow hover:shadow-lg transition">
              ...
              <p className="text-gray-600 mb-6">
                Discover certified adventure guides and instructors for every
                level.
              </p>
              <button
                onClick={handleViewTrainers}
            ...
            <div className="bg-white rounded-xl p-8 shadow hover:shadow-lg transition">
              ...
              <p className="text-gray-600 mb-6">
                Explore adventure academies and outdoor centers with expert
                facilities.
              </p>
              <button
                onClick={handleViewInstitutes}
            ...
            <div className="bg-white rounded-xl p-8 shadow hover:shadow-lg transition">
              ...
              <p className="text-gray-600 mb-6">
                Step outside your comfort zone and experience the thrill of the
                outdoors.
              </p>
