    ...
    <div className="font-sans bg-gray-50 text-gray-800">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
          <button className="flex items-center justify-center gap-2 bg-orange-500 text-white px-6 py-3 rounded-full hover:bg-orange-600 transition">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {categories.map((item) => (
            ...
            >
              ...
              <button className="bg-white text-orange-600 px-5 py-2 rounded-full font-medium hover:bg-gray-100 transition">
                Select
              </button>
            </div>
          ))}
